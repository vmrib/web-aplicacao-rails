...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference("Documento.count") do
      post documentos_url, params: { documento: { cpf: @documento.cpf, pessoa_id: @documento.pessoa_id, rg: @documento.rg } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { cpf: @documento.cpf, pessoa_id: @documento.pessoa_id, rg: @documento.rg } }
