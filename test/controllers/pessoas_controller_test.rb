...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { estado_id: @pessoa.estado_id, nome: @pessoa.nome, sobrenome: @pessoa.sobrenome } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { estado_id: @pessoa.estado_id, nome: @pessoa.nome, sobrenome: @pessoa.sobrenome } }
